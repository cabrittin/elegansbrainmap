...
def plot_synapse_lost_membrane_contact(ax,syn_lost,syn_n,edge_thresh=35):
...
if __name__=="__main__":
    ...
    plot_synapse_lost_membrane_contact(ax[0],chem_lost,chem_n) 
    ax[0].set_ylabel('Fraction of $\mathbb{C}^\delta$',fontsize=FS) 
    #ax[0].set_title('Synapses at $\mathbb{M}^4$',fontsize=FS) 
    plot_synapse_lost_membrane_contact(ax[1],gap_lost,gap_n) 
